...
async def create_nl_request(
    ...
    return CreateNLResponse(
        ...
        debate_transcript_json=result.get("debate_transcript"),
...
async def get_request_details(
    ...
    for it in req.iterations:
        ...
        iterations.append(
            IterationDetail(
                ...
                critic_score=it.critic_score,
                rationale=it.rationale,
                debate_transcript_json=it.debate_transcript_json,
    ...
    return GetRequestResponse(
        ...
        critic_score=iteration.critic_score if iteration else None,
        rationale=iteration.rationale if iteration else None,
        debate_transcript_json=iteration.debate_transcript_json if iteration else None,
